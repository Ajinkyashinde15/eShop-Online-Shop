...
namespace eShop.API.Migrations
{
    ...
    [Migration("20200229133643_IdentityMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShop.API.Models.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("eShop.API.Models.Order", b =>
                {
                    b.HasOne("eShop.API.Models.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eShop.API.Models.Entities.StoreUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
